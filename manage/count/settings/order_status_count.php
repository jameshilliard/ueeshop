...
<settings>
  ...
  <data_labels>
    <radius></radius>                                         <!-- [30%] (Number / Number%) distance of the labels from the pie. Use negative value to place labels on the pie -->
  ...
  <balloon>                                                   <!-- BALLOON -->
    ...
    <text_size></text_size>                                   <!-- [text_size] (Number) -->
    <show>
       <![CDATA[{title}: {value}<?=get_lang('count.order_row_count');?>]]>              <!-- [] ({value} {title} {percents}) You can format any data label: {value} - will be replaced with value and so on. You can add your own text or html code too. -->
    </show>
  </balloon>
  ...
  <export_as_image>                                           <!-- export_as_image feature works only on a web server -->
    ...
    <target>iframe_data_all_level</target>                                         <!-- [] (_blank, _top ...) target of a window in which export file must be called -->
  ...
  <labels>                                                    <!-- LABELS -->
    ...
    <label lid="0">
      ...
      <text>                                                  <!-- [] (text) html tags may be used (supports <b>, <i>, <u>, <font>, <a href="">, <br/>. Enter text between []: <![CDATA[your <b>bold</b> and <i>italic</i> text]]>-->
        <![CDATA[<b><?=get_lang('count.order_status_count');?></b>]]>
      </text>
    </label>
