...
?>
<div class="header"><?=get_lang('ly200.current_location');?>:<a href="order_price_trend.php"><?=get_lang('count.order_price_trend');?></a></div>
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="bat_form">
	<tr>
		<td height="22" class="flh_150">
			<form method="get" name="order_view_form" action="order_price_trend.php" onsubmit="this.submit.disabled=true;">
...
<table width="100%" border="0" cellpadding="0" cellspacing="1">
	<tr>
		<td>
			...
			<div id="order_price_trend_data"></div>
			...
			soxxzst.addVariable('settings_file', escape('settings/order_price_trend.php?<?=$service_time;?>'));
			soxxzst.addVariable('data_file', escape('data/order_price_trend.php?<?=query_string().'&t='.$service_time;?>'));
			soxxzst.addVariable('preloader_color', '#000000');
			soxxzst.write('order_price_trend_data');
			</script>
		</td>
	</tr>
</table>
