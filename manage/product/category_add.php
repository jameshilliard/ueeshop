...
<table width="100%" border="0" cellpadding="0" cellspacing="1" id="mouse_trBgcolor_table">
	...
	<?php }?>
    <tr>
			<td width="5%" nowrap>显示色卡:</td>
			<td width="95%"><input type="checkbox" name="ColorCard" value="1" /></td>
	</tr>
    <tr>
			<td width="5%" nowrap>导航显示:</td>
			<td width="95%"><input type="checkbox" name="OnNav" value="1" /></td>
	</tr>
	...
	<?php if(get_cfg('product.category.dept')>1){?>
		<tr>
			...
			<td><?=ouput_Category_to_Select('UnderTheCateId', '', 'product_category', 'UId="0,"', 'Dept<'.get_cfg('product.category.dept'), get_lang('ly200.select'));?></td>
		</tr>
	<?php }?>
