...
<table width="100%" border="0" cellpadding="0" cellspacing="1" id="mouse_trBgcolor_table">
    ...
    <tr>
			...
			<td width="95%"><input type="checkbox" name="ColorCard" value="1"  <?=$category_row['ColorCard']==1?'checked="checked"':''?> /></td>
	</tr>
    <tr>
			<td width="5%" nowrap>导航显示:</td>
			<td width="95%"><input type="checkbox" name="OnNav" value="1"  <?=$category_row['OnNav']==1?'checked="checked"':''?> /></td>
	</tr>
