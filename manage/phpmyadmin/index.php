...
if ($cfg['LeftDisplayLogo'] && @file_exists($logo_image)) {
    ...
    // theme 'default'? (TODO: improve with a parameter in layout.inc.php)
    $query_frame_height += ((!isset($GLOBALS['theme']) || $GLOBALS['theme']=='default') ? 25 : 0);
}
...
// increase the height to take into account font size differences in
// theme 'default'? (TODO: improve with a parameter in layout.inc.php)
$query_frame_height += ((!isset($GLOBALS['theme']) || $GLOBALS['theme']=='default') ? 20 : 10);
