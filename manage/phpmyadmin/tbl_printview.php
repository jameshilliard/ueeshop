...
<tr>
    ...
    while ($row = PMA_DBI_fetch_assoc($result)) {
        ...
        ?>
<tr>
    <td width="50" class="print" nowrap>
    <?php
    ...
    <!--<td width="50" bgcolor="<?php echo $bgcolor;?>" nowrap><?php echo $strAttribute;?></td>-->
    <td width="40" class="print"><?php echo (($row['Null'] == '') ? $strNo : $strYes);?>&nbsp;</td>
    <td width="70" class="print" nowrap><?php if (isset($row['Default'])) echo $row['Default'];?>&nbsp;</td>
    <!--<td width="50" bgcolor="<?php echo $bgcolor;?>" nowrap><?php echo $row['Extra'];?>&nbsp;</td>-->
    <?php
    echo "\n";
    if ($have_rel) {
        echo '    <td class="print">';
...
<tr>
    ...
    <td class="print" valign="top">
        ...
        <tr>
            ...
            <td align="right" class="print" nowrap><?php echo $data_size;?></td>
        ...
        <tr>
            ...
            <td align="right" class="print" nowrap><?php echo $index_size;?></td>
        ...
        <tr style="color: #bb0000">
            ...
            <td align="right" class="print" nowrap><?php echo $free_size;?></td>
            <td class="print"><?php echo $free_unit;?></td>
        </tr>
        <tr>
            <td class="print" style="padding-right: 10px"><?php echo $strEffective;?></td>
            <td align="right" class="print" nowrap><?php echo $effect_size;?></td>
        ...
        <tr>
            ...
            <td align="right" class="print" nowrap><?php echo $tot_size;?></td>
    ...
    <td valign="top">
        ...
        <tr>
            ...
            <td align="<?php echo $cell_align_left;?>" class="print" nowrap>
                <?php
                echo '                ';
        ...
        <tr>
            ...
            <td align="right" class="print" nowrap>
