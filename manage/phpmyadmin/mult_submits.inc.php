<?php
/* $Id: mult_submits.inc.php,v 2.13 2005/01/12 00:31:42 rabus Exp $ */
...
<form action="<?php echo $action;?>" method="post">
    ...
    <?php
    if ($what == 'row_delete') {
        echo '<input type="hidden" name="default_sql_query" value="' . htmlspecialchars($default_sql_query) . '" />' . "\n";
        echo '<input type="hidden" name="default_pos" value="' . $default_pos . '" />' . "\n";
        echo '<input type="hidden" name="default_url_query" value="' . htmlspecialchars($default_url_query) . '" />' . "\n";
    }
    ?>
