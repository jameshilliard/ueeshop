...
if (count($statistics) > 0) {
    ...
    if ($is_superuser && empty($dbstats)) {
        echo '        ' . ($GLOBALS['cfg']['PropertiesIconic'] ? '<tr><td colspan="2">' : '<li>') . "\n"
           ...
           . '                </a>' . "\n"
           . '            </b>' . "\n"
           . '           ' . ($GLOBALS['cfg']['PropertiesIconic'] ? '</td></tr><tr><td width="20" nowrap>&nbsp;</td><td>' : '<br />') . "\n"
    ...
    if ($is_superuser || $cfg['AllowUserDropDatabase']) {
        echo '        ' . ($GLOBALS['cfg']['PropertiesIconic'] ? '<tr><td colspan="2">' : '<li>') . "\n"
           ...
           . '            </b>' . "\n"
           . '           ' . ($GLOBALS['cfg']['PropertiesIconic'] ? '</td></tr><tr><td width="20" nowrap>&nbsp;</td><td nowrap align="left" width="400">' : '<br />') . "\n"
