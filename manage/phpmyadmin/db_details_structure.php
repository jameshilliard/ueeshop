...
<?php
    ...
    <td valign="top">
        ...
        ?>
                ...
                <td bgcolor="<?php echo $bgcolor;?>" nowrap <?php echo $click_mouse;?>>
	...
	$drop_query = 'DROP '
        ...
        if (isset($sts_data['Rows']) || (PMA_MYSQL_INT_VERSION >= 50000 && $db == 'information_schema')) {
            ...
            if (!($cfg['PropertiesNumColumns'] > 1)) {
                echo '                <td bgcolor="' . $bgcolor . '" nowrap ' . $click_mouse . '>' . "\n"
            ...
            if ($cfg['ShowStats']) {
                echo "\n";
                ?>
                <td align="right" bgcolor="<?php echo $bgcolor;?>" nowrap <?php echo $click_mouse;?>>
                    &nbsp;&nbsp;
...
<table border="0" cellpadding="2" cellspacing="0">
    <!-- Create a new table -->
     ...
     <tr>
     <td class="tblHeaders" colspan="3" nowrap><?php
...
echo '     </td></tr>';
echo '     <tr bgcolor="'.$cfg['BgcolorOne'].'"><td nowrap>';
echo '             ' . $strName . ':&nbsp;' . "\n";
echo '     </td>';
echo '     <td nowrap>';
