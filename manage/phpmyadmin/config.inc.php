...
$cfg['Servers'][$i]['port']          = $db_port;          // MySQL port - leave blank for default port
...
$cfg['Servers'][$i]['user']          = $db_username;      // MySQL user
$cfg['Servers'][$i]['password']      = $db_password;          // MySQL password (only needed
                                                    // with 'config' auth_type)
$cfg['Servers'][$i]['only_db']       = $db_database;          // If set to a db-name, only
...
$cfg['ThemeDefault']        = 'default';         // set up default theme, if ThemePath not empty
                                             // you can set up here an valid path to themes or 'default' for
                                             // the default pma-theme
 ...
 */
$cfg['DefaultQueryTable']    = 'SELECT * FROM %t';
