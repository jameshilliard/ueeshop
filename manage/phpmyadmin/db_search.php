<?php
/* $Id: db_search.php,v 2.11 2004/10/12 21:08:49 rabus Exp $ */
...
<br />
        ...
        if (isset($onetable)) {
            ...
            echo '    ' . sprintf($strSearchResultsFor, htmlspecialchars($default_search_str), $option_str) . "\n";
            echo '    <br />' . "\n";
 ...
 */
echo "\n";
$searched          = (isset($default_search_str))
                   ? htmlspecialchars($default_search_str)
                   : '';
