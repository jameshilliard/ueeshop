...
for ($y = 0; $y <= $row; $y++) {
    ...
    if (isset($InsRow[$y]) && $InsRow[$y] == 'on') {
        ...
        ?>
    <tr>
        <td align="<?php echo $cell_align_right;?>" bgcolor="<?php echo $bgcolor;?>" nowrap>
            <!-- Row controls -->
            <table bgcolor="<?php echo $bgcolor;?>" cellpadding="0" cellspacing="0" border="0">
            <tr>
                <td align="<?php echo $cell_align_right;?>" nowrap>
...
<table border="0" cellpadding="2" cellspacing="1">
    <tr>
        <td nowrap><input type="hidden" value="<?php echo htmlspecialchars($db);?>" name="db" />
        ...
        <td width="10">&nbsp;</td>
        <td nowrap><?php echo $strAddDeleteColumn;?>:
...
// Code defaultly by Mike Beck <mike.beck@ibmiller.de>
