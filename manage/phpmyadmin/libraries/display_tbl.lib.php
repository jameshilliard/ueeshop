        ...
        if ($is_display['sort_lnk'] == '1') {
            ...
            if (isset($order_link_words[1])) {
                ...
                $order_link = $order_link_pre . implode(' ', $order_link_words)
                            . ' <div class>' . $order_last_word . $order_img . '</div>' . $order_link_post . "\n";
            } else {
                $order_link = '<div class>' . $order_link_pre . $order_link_content . $order_link_post . $order_img . '</div>' . "\n";
            }
        ...
        for ($i = 0; $i < $fields_cnt; ++$i) {
            ...
            //       associative and numeric indices?
                ...
                if (!isset($row[$i]) || is_null($row[$i])) {
                    ...
                    $vertical_display['data'][$row_no][$i]     = '    <td align="right" valign="top" ' . $column_style . ' bgcolor="' . $bgcolor . '" class>';
                    ...
                    $vertical_display['data'][$row_no][$i]     = '    <td align="right" ' . $column_style . ' valign="top" bgcolor="' . $bgcolor . '" class>&nbsp;</td>' . "\n";
                }
