...
<div id="lib_instance_list">
	...
	<div class="item" style="width:<?=sprintf('%01.2f', 100/$list_row_count);?>%;">
		<ul style="width:<?=$instance_img_width+2;?>px;">
			<li class="img" style="width:<?=$instance_img_width;?>px; height:<?=$instance_img_height;?>px"><div><a href="<?=$url;?>" target="_blank"><img src="<?=$instance_row[$i]['PicPath_0'];?>"/></a></div></li>
			<li><a href="<?=$url;?>" target="_blank"><?=$instance_row[$i]['Name'];?></a></li>
		</ul>
	</div>
...
<?php
$instance_list_lang_0=ob_get_contents();
ob_clean();
?>